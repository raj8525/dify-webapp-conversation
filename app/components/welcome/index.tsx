...
const Welcome: FC<IWelcomeProps> = ({
  ...
  const renderHeader = () => {
    return (
      <div className='absolute top-0 left-0 right-0 flex items-center justify-between border-b border-gray-900 mobile:h-12 tablet:h-16 px-8 bg-zinc=950'>
        <div className='text-gray-300'>{conversationName}</div>
      </div>
    )
  }
